...
const MODES = [
  { id: 'full',      label: 'Full Check-In',       subtitle: 'Nutrition, body comp, recovery gaps', icon: Sparkles },
  { id: 'nutrition', label: 'Nutrition Focus',      subtitle: 'Deep dive on macros and calorie timing', icon: Apple },
  { id: 'body',      label: 'Body Composition',     subtitle: 'Weight, lean mass, BF% trajectory', icon: Scale },
]
    ...
    <div className="space-y-4">
      {analysis && !loading && (
        <div className="flex justify-end">
          <button
            onClick={runAnalysis}
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-card border border-line text-ink3 text-xs font-semibold active:scale-95 transition-transform"
          >
            <RefreshCw size={13} />
            Refresh
          </button>
